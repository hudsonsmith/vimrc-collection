...
" Disable Arrow Keys.
nnoremap <Left> :echo "Don't use the arrow keys!"<CR>
nnoremap <Right> :echo "Don't use the arrow keys!"<CR>
nnoremap <Up> :echo "Don't use the arrow keys!"<CR>
nnoremap <Down> :echo "Don't use the arrow keys!"<CR>
